...
if (Test-Path -Path "C:\Windows\SYSVOL\domain\Policies\Datasources.xml") {
    Write-Warning "Datasources.xml already exists at C:\Windows\SYSVOL\domain\Policies\Datasources.xml on $env:computername"
} else {
...
if (Test-Path -Path "C:\Windows\SYSVOL\domain\Policies\Registry.xml") {
    Write-Warning "Registry.xml already exists at C:\Windows\SYSVOL\domain\Policies\Registry.xml on $env:computername"
} else {
